...
import { FileText, Users, PieChart, Zap } from "lucide-react";
...
export function TalentSparkFeatures() {
                ...
                <div className="flex justify-center">
                  <div className="flex h-full flex-col justify-center gap-10 p-4 md:h-[300px] md:flex-row">
                    ...
                    <div className="flex h-full flex-col justify-center p-2 md:ml-10 md:w-[400px]">
                      ...
                      <div className="flex justify-center">
                        <Link to="/login">
                          <Button className="bg-recruit-primary hover:bg-recruit-primary/90">Get Started Today</Button>
                        </Link>
                      </div>
                    </div>
                  </div>
